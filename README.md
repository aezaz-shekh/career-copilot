...
**A privacy-first, 100%-local, zero-cost AI career assistant.**
No cloud services, no API keys, no subscriptions — every byte of your data stays
on your own machine, and the only network request the app ever makes is a
...
| Home dashboard | Resume review | Mock interview |
|---|---|---|
| ![Dashboard](docs/screenshots/dashboard.png) | ![Review](docs/screenshots/review.png) | ![Interview](docs/screenshots/interview.png) |

| Roadmap | Outreach drafter | Setup wizard |
|---|---|---|
| ![Roadmap](docs/screenshots/roadmap.png) | ![Outreach](docs/screenshots/outreach.png) | ![Setup](docs/screenshots/setup.png) |
